...
contract MockSeanceCircle is ERC20('SeanceCircle', 'SEANCE'), Ownable, Operable {
    ...
    function initialize(MockSoulPower _soul) external onlyOwner {
    ...
    function newSoul(MockSoulPower _soul) external onlyOperator {
