...
contract SoulBondV3 is AccessControl, ReentrancyGuard {
    ...
    // pair addresses
    address private immutable soul_native;  //
    address private immutable soul_usdc;    //
    address private immutable usdc_ftm;     //
    address private immutable eth_native;   //
    address private immutable btc_native;   //
    address private immutable usdc_dai;     //
    ...
    function initialize(
        ...
        addPool(250, IERC20(_soul_native), true);
        addPool(150, IERC20(_soul_usdc), true);
        addPool(150, IERC20(_usdc_native), true);
        addPool(150, IERC20(_eth_native), true);
        addPool(150, IERC20(_btc_native), true);
        addPool(150, IERC20(_usdc_dai), true);
