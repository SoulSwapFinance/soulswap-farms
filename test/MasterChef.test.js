...
contract('MasterChef', ([alice, bob, team, treasury, minter]) => {
    beforeEach(async () => {
        ...
        this.chef = await MasterChef.new(this.soul.address, this.seance.address, team, treasury, await time.latest(), { from: minter });
    ...
    it('real case', async () => {
      ...
      await this.soul.approve(this.chef.address, '1000', { from: alice });
    ...
    it('staking/unstaking', async () => {
      ...
      await this.soul.approve(this.chef.address, '250', { from: alice });
    ...
    it('update multiplier', async () => {
      ...
      await this.soul.approve(this.chef.address, '100', { from: alice });
      await this.soul.approve(this.chef.address, '100', { from: bob });
